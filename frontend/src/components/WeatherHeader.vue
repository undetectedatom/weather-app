<template>
  <header class="header panel">
    ...
    <div class="header-right">
      ...
      <button class="ghost-button" type="button" @click="$emit('home')">{{ labels.home }}</button>
    </div>
  </header>
</template>
...
.status-pill { padding: 8px 12px; border-radius: 999px; background: #edf5ef; border: 1px solid #d6e1d8; color: #2f7d4b; font-size: 0.95rem; }
...
@media (max-width: 960px) {
  ...
  .header-middle { justify-content: flex-start; }
